  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: "Con il protocollo MUV integrato, i primi risultati visibili si manifestano già dalla 4a settimana. Per il dimagrimento, perderai 3-5kg di grasso in 8 settimane."
    },
    {
      question: "L'EMS è sicuro?",
      answer: "L'EMS è una tecnologia certificata e validata scientificamente, utilizzata in ambito medico-riabilitativo da decenni. Durante la valutazione iniziale verifichiamo l'idoneità completa."
    },
    {
      question: "Devo avere esperienza in palestra?",
      answer: "Assolutamente no. I nostri protocolli sono progettati per tutti i livelli: principianti assoluti, persone sedentarie, atleti esperti e over 60."
    },
    {
      question: "Quanto durano le sessioni?",
      answer: "Le sessioni EMS durano 20 minuti, il Pilates Reformer 50 minuti. La frequenza ottimale è 2-3 volte/settimana."
    },
    {
    ...
    },
    {
      ...
      answer: "Certamente. Offriamo una prova gratuita completa di 90 minuti che include valutazione, presentazione del protocollo e sessione trial. Zero impegno."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Perdi 4-8kg in 8 settimane con sessioni da 20 minuti. Centro fitness boutique a Legnago con EMS Training, Pilates Reformer. Ambiente riservato, risultati garantiti. Prova gratuita." 
        />
        <meta 
          name="keywords" 
        ...
        <meta property="og:description" content="Perdi 4-8kg in 8 settimane con sessioni da 20 minuti. Ambiente riservato, zero attese." />
