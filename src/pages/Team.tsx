...
const Team = () => {
  const structuredData = [getLocalBusinessSchema(), getOrganizationSchema()];
  ...
  const teamMembers = [
    {
      ...
      description:
        "Visionario del fitness innovativo, ha creato Centro fitness MUV per rivoluzionare l'approccio al benessere a Legnago. Esperto in gestione di centri fitness di eccellenza.",
    ...
    },
    {
      ...
      description:
        "Laureato in Scienze Motorie, tecnico certificato Pancafit. Ha risolto problemi di mal di schiena a centinaia di clienti. Il 95% elimina il dolore entro 6 settimane.",
    ...
    },
    {
      ...
      description:
        "Laureata in Scienze Motorie, specialista in tecnologia EMS e massaggi terapeutici. Esperta nel dimagrimento femminile e rimodellamento corporeo.",
    ...
    },
    {
      ...
      description:
        "Diplomata in estetica e benessere, con esperienza pluriennale in centri di dimagrimento. Specializzata nell'approccio olistico al benessere femminile.",
    ...
    },
    {
      ...
      description:
        "20 anni di esperienza nel fitness. Specialista in allenamenti per potenziamento muscolare e dimagrimento. Ha trasformato il fisico di oltre 500 clienti.",
      specialization: "Forza e Massa Muscolare",
    },
    {
      name: "Thomas Gabrieli",
      role: "Personal Trainer Senior",
      image: "https://baujoowgqeyraqnukkmw.supabase.co/storage/v1/object/public/immagini/Thomas%20Gabrieli.jpg",
      description:
          ...
          <div className="container mx-auto max-w-7xl">
            <header className="text-center mb-10 sm:mb-14 lg:mb-16">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 leading-tight px-2 text-foreground">
                I migliori Personal Trainer di <span className="text-primary block sm:inline">Legnago</span>
              </h1>
              <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed px-4">
                ...
                Ogni specialista ha una missione:{" "}
                <span className="text-primary">trasformare il tuo corpo e la tua vita</span>.
              </p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
              {teamMembers.map((member, index) => (
                <Card
                  key={index}
                  className="bg-gray-800 border-gray-700 hover:border-pink-600 transition-all duration-300 transform hover:scale-105"
                >
