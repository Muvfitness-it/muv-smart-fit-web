  ...
  const metodologia = [
    {
      ...
      description:
        "Analisi completa della composizione corporea, postura e obiettivi personali. Definiamo insieme il percorso migliore per te.",
    },
    {
      icon: TrendingUp,
      title: "Programma Personalizzato",
      description:
        "Non esistono allenamenti standard da noi. Ogni sessione è progettata sulle tue esigenze, capacità e obiettivi specifici.",
    },
    {
      icon: LineChart,
      title: "Monitoraggio Costante",
      description:
        "Verifichiamo i progressi con dati oggettivi: peso, circonferenze, massa magra/grassa. Adattiamo il programma per risultati ottimali.",
    },
    {
      icon: Heart,
      title: "Approccio Olistico",
      description:
        "Non solo allenamento: integriamo nutrizione, supporto psicologico e tecnologie avanzate per una trasformazione a 360°.",
    },
  ];
  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "Il Kit Zero Pensieri è la nostra soluzione per eliminare ogni preoccupazione: ti forniamo asciugamani da doccia e palestra, vestiario tecnico completo per allenarti, prodotti doccia professionali e, quando necessario, anche borraccia e integratori. Vieni e pensa solo al tuo allenamento.",
    },
    {
      question: "Devo portare qualcosa per allenarmi?",
      answer:
        "No, assolutamente niente. Forniamo tutto il necessario: abbigliamento tecnico, scarpe da training se serve, asciugamani e prodotti per la doccia. Molti clienti vengono direttamente dall'ufficio in pausa pranzo senza problemi.",
    },
    {
      question: "Quanto dura una sessione tipo da MUV?",
      answer:
        "Una sessione standard dura 50-60 minuti: 10 minuti preparazione e valutazione, 30-40 minuti allenamento intenso e personalizzato, 10 minuti defaticamento. Con l'EMS, 45 minuti equivalgono a 3 ore di palestra tradizionale.",
    },
    {
      question: "Posso venire solo per provare?",
      answer:
        "Sì! Offriamo una prova gratuita completa di 90 minuti che include: valutazione iniziale (composizione corporea + postura), consulenza personalizzata, sessione trial con la tecnologia scelta (EMS o Reformer). Zero impegno, zero costi nascosti.",
    },
    {
      question: "MUV è adatto ai principianti?",
      answer:
        "Assolutamente sì. Il 60% dei nostri clienti arriva da noi senza esperienza pregressa in palestra. Ogni programma parte dal tuo livello attuale e progredisce gradualmente. Segui sempre personalmente da un trainer dedicato.",
    },
    {
      question: "Posso allenarmi in qualsiasi orario?",
      answer:
        "Lavoriamo su appuntamento per garantire attenzione personalizzata. Siamo aperti da lunedì a sabato, 7:00-21:00. Puoi prenotare la fascia oraria che preferisci, molti clienti si allenano in pausa pranzo (12:00-14:00) o dopo lavoro (18:00-20:00).",
    },
    {
      question: "Cosa rende MUV davvero diverso da una palestra?",
      answer:
        "In una palestra tradizionale compri accesso a una sala con macchine. Da MUV acquisti una trasformazione guidata: valutazione scientifica, programma personalizzato, tecnologie avanzate (EMS, Reformer, Sauna), supporto nutrizionale e psicologico, monitoraggio continuo. Non vendiamo abbonamenti, creiamo risultati.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Perché MUV Non È Una Palestra Tradizionale | Fitness Personalizzato Legnago"
        />
        <meta
          property="og:description"
          content="Scopri cosa rende MUV unico: valutazione personalizzata, tecnologie avanzate, Kit Zero Pensieri e risultati garantiti."
        />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-body-lg leading-relaxed text-muted-foreground mb-6">
              Le palestre tradizionali vendono <strong className="text-foreground">spazi generici</strong> con macchine
              e sale affollate. Ti danno un abbonamento e ti lasciano solo a capire cosa fare.
            </p>
            ...
            <p className="text-body-lg leading-relaxed text-muted-foreground">
              MUV è un <strong className="text-accent">centro di trasformazione personalizzata</strong> dove ogni
              cliente ha un programma su misura, tecnologie avanzate, supporto costante e un team dedicato ai suoi
              risultati. Non sei un numero, sei <em>tu</em> con i tuoi obiettivi unici.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-background" aria-label="Il Metodo MUV">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto animate-fade-in">
            <h2 className="text-heading-lg text-center mb-4">Il Metodo MUV in 4 Fasi</h2>
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h3 className="text-heading-sm mb-3">{fase.title}</h3>
                      <p className="text-body-sm text-muted-foreground">{fase.description}</p>
                    </div>
                  </Card>
                );
              })}
      ...
      <section className="section-padding bg-muted/30" aria-label="Testimonianze clienti">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto animate-fade-in">
            <h2 className="text-heading-lg text-center mb-4">Cosa Dicono i Nostri Clienti</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <Card
                  ...
                  style={{ animationDelay: `${index * 150}ms` }}
                >
                  <p className="text-body-md text-muted-foreground italic mb-4">"{testimonial.text}"</p>
      ...
      {/* CTA Finale */}
      <section
        className="section-padding bg-gradient-to-br from-accent via-primary to-secondary"
        aria-label="Chiamata all'azione"
      >
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            <h2 className="text-heading-lg mb-4 text-white">Vieni a Provare La Differenza</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a href="tel:+393291070374">Chiamaci: 329 107 0374</a>
              </Button>
            </div>
            <p className="text-sm text-white/80 mt-6">Oltre 500 clienti soddisfatti a Legnago hanno già scelto MUV</p>
          </div>
        </div>
      </section>

      {/* FAQ */}
      <FAQAccordion title="Domande Frequenti su MUV" faqs={faqs} />
    </>
  );
};
