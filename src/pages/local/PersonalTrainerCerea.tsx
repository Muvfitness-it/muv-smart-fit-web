...
const PersonalTrainerCerea = () => {
  ...
  const localFAQs = [
    ...
    },
    {
      ...
      answer: `L'EMS Training è perfetto per chi ha poco tempo: 45 minuti di allenamento equivalgono a 90 minuti di palestra tradizionale. Ideale per ottimizzare i tempi di viaggio da Cerea!`,
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="personal trainer cerea, palestra cerea, ems training cerea, pilates cerea, fitness cerea, dimagrire cerea"
        />
        ...
        <meta
          ...
          content="Il tuo personal trainer di fiducia vicino a Cerea. Tecnologie avanzate e risultati garantiti a soli 12 minuti da te."
        />
