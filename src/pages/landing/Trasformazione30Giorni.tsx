...
const Trasformazione30Giorni = () => {
  ...
  const testimonials = [
    {
      ...
      age: 35,
      result: "-12kg",
      testimonial: "Non credevo fosse possibile. In 30 giorni ho perso 12kg e mi sento rinato. Il metodo MUV funziona davvero!",
      timeframe: "30 giorni"
    },
    {
      name: "Elena Bianchi",
      ...
      testimonial: "Finalmente ho ritrovato la mia forma dopo la gravidanza. Staff professionale e risultati garantiti!",
      timeframe: "28 giorni"
    },
    {
      name: "Andrea Ferri",
    ...
    },
    {
      ...
      age: 31,
      result: "-10kg",
      testimonial: "Il programma ha cambiato la mia vita. Non solo ho perso peso, ma ho acquisito fiducia in me stessa.",
      timeframe: "30 giorni"
    },
    {
      name: "Roberto Costa",
    ...
    },
    {
      ...
      age: 26,
      result: "-7kg + Tono",
      testimonial: "Non solo ho perso peso, ma ho guadagnato massa muscolare. Il mio corpo non è mai stato così tonico!",
      timeframe: "25 giorni"
    }
  ];
  ...
  return (
    <LandingTemplate
      title="Trasformazione Garantita in 30 Giorni | MUV Smart Fit Legnago"
    ...
    >
      ...
      <LandingCountdown 
        ...
        title="⏰ OFFERTA LIMITATA IN SCADENZA"
      />
