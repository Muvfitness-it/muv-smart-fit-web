...
const ProvaGratuitaEMS = () => {
  const structuredData = {
    ...
    description:
      "Prova gratuita di allenamento EMS a Legnago. Elettrostimolazione muscolare per dimagrimento rapido e tonificazione.",
  ...
  const faq = [
    {
      ...
      answer:
        "Sì, la prova gratuita include: consulenza iniziale, test posturale, sessione EMS completa di 45 minuti e piano personalizzato.",
    },
    {
      question: "Devo portare abbigliamento specifico?",
      answer:
        "No, forniamo noi tutto il necessario: tuta EMS, calze e asciugamani. Porta solo scarpe da ginnastica pulite.",
    },
    {
      question: "Ci sono controindicazioni?",
      answer:
        "L'EMS è sicuro per la maggior parte delle persone. Durante la consulenza verifichiamo eventuali controindicazioni specifiche.",
    },
  ];
    ...
    >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-lg mb-8 opacity-90">
                45 minuti di allenamento EMS equivalgono a 4 ore di palestra tradizionale. Scopri il futuro del fitness
                a Legnago!
              </p>
            ...
            <div className="bg-white rounded-lg p-8 shadow-2xl">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Prenota la Tua Prova Gratuita</h2>
                <p className="text-gray-600">Zero impegno. Ti richiamiamo entro 24 ore.</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6">
              <CardContent className="pt-0">
                ...
                <p className="mb-4 italic">
                  "In 6 settimane ho perso 8 kg e la mia schiena non mi fa più male. L'EMS è incredibile!"
                </p>
            ...
            <Card className="p-6">
              <CardContent className="pt-0">
                ...
                <p className="mb-4 italic">
                  "45 minuti che valgono ore di palestra. Finalmente un allenamento che si adatta ai miei tempi!"
                </p>
                <div className="font-semibold">
                  <p>Marco R., 38 anni</p>
            ...
            <Card className="p-6">
              <CardContent className="pt-0">
                ...
                <p className="mb-4 italic">
                  "Dopo il parto pensavo di non riuscire più a tornare in forma. L'EMS mi ha ridato fiducia!"
                </p>
                <div className="font-semibold">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">Tutto quello che devi sapere sulla prova gratuita EMS</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600">
        <div className="container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Non Perdere Questa Occasione!</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Solo 10 posti disponibili questo mese per la prova gratuita EMS. Prenota ora e inizia la tua trasformazione!
          </p>
          ...
          <p className="text-sm mt-6 opacity-90">Disponibilità limitata - Affrettati a prenotare!</p>
        </div>
      </section>
    </ServicePageLayout>
  );
