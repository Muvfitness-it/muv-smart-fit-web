      ...
      <main className="min-h-screen">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-heading font-black mb-6">
                Pacchetti <span className="text-brand-primary">dedicati</span>
              </h2>
              <p className="text-xl text-muted-foreground mb-12">
                Soluzioni flessibili per ogni fase della maternità
              </p>

              <div className="grid md:grid-cols-2 gap-8">
                <Card className="border-brand-primary/30 relative">
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-brand-primary text-white px-4 py-2 rounded-full text-sm font-bold">
                      PRE-PARTO
                    </span>
                  </div>
                  <CardContent className="p-8 pt-12">
                    <h3 className="text-2xl font-bold mb-4">Preparazione Parto</h3>
                    <div className="text-3xl font-black text-brand-primary mb-6">
                      Da 60€<span className="text-lg font-normal">/settimana</span>
                    </div>
                    <ul className="text-left space-y-3 mb-8">
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>2 sessioni Pilates pre-natale/settimana</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>Esercizi pavimento pelvico</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>Ginnastica dolce specifica</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                ...
                <Card className="border-brand-secondary/30 relative">
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-brand-secondary text-white px-4 py-2 rounded-full text-sm font-bold">
                      POST-PARTO
                    </span>
                  </div>
                  <CardContent className="p-8 pt-12">
                    <h3 className="text-2xl font-bold mb-4">Recupero Forma</h3>
                    <div className="text-3xl font-black text-brand-secondary mb-6">
                      Da 70€<span className="text-lg font-normal">/settimana</span>
                    </div>
                    <ul className="text-left space-y-3 mb-8">
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>EMS + Pilates personalizzato</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>Pancafit® per la postura</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>Piano nutrizionale post-parto</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="text-green-600" size={20} />
                        <span>Orari flessibili baby-friendly</span>
                      </li>
                    </ul>
                    <Link to="/form-contatti">
              ...
              <div className="mt-12 p-6 bg-brand-accent/10 rounded-2xl">
                <p className="text-lg font-semibold text-brand-accent mb-2">
                  🎁 GARANZIA 30 GIORNI
                </p>
                <p className="text-muted-foreground">
                  Se non sei completamente soddisfatta dei risultati, ti rimborsiamo il 100% del investimento. 
                  <strong> Zero rischi, solo benefici!</strong>
                </p>
              </div>
            </div>
          </div>
