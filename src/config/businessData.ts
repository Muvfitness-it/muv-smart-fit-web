...
export const BUSINESS_DATA = {
  ...
  description:
    "Centro fitness boutique a Legnago (VR) specializzato in dimagrimento rapido, correzione posturale e riabilitazione funzionale mediante tecnologie certificate: EMS Training, Pilates Reformer, Vacuum Therapy, Sauna Infrarossi.",
  ...
  geo: {
    ...
    googleMapsEmbed:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2801.234!2d11.3065!3d45.1914!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDXCsDExJzI5LjAiTiAxMcKwMTgnMjMuNCJF!5e0!3m2!1sit!2sit!4v1234567890",
  },

  // === ORARI DI APERTURA (formato standardizzato) ===
  openingHours: {
    // Orari per schema markup (formato Schema.org)
    schemaFormat: ["Mo-Fr 08:00-21:00", "Sa 08:00-12:00"],
  ...
  services: [
    {
      ...
      description:
        "Elettrostimolazione muscolare integrale per perdita grasso accelerata e tonificazione completa in 45 minuti",
  ...
  geoKeywords: {
    primary: ["muv fitness legnago", "palestra legnago", "personal trainer legnago", "ems legnago"],
    secondary: [
  ...
  geoFAQs: [
    {
      ...
      answer:
        "MUV Fitness si trova in Piazzetta Don Walter Soave, 2 a Legnago (VR), nel centro storico. A 5 minuti a piedi dalla stazione ferroviaria e a 300 metri da Piazza Libertà. Parcheggi disponibili nelle vie limitrofe.",
    },
    {
      question: "MUV Fitness ha parcheggio?",
      answer:
        "Sono disponibili parcheggi gratuiti nelle vie limitrofe al centro (Via Matteotti, Via Frattini) e parcheggi a pagamento con strisce blu nel centro storico. In bicicletta, rastrelliere disponibili in Piazzetta Don Walter Soave.",
    },
    {
      question: "Da quali zone arrivano i clienti MUV Fitness?",
      answer:
        "I nostri clienti provengono principalmente da Legnago e dalla Bassa Veronese: Cerea (10km), Bovolone (15km), San Bonifacio (20km), Minerbe, Castagnaro e Angiari. Alcuni arrivano anche da Verona città per le nostre tecnologie esclusive.",
    },
    {
      question: "Quanto costa un abbonamento a MUV Fitness Legnago?",
      answer:
        "I costi variano in base al servizio e alla frequenza. Il pacchetto Starter parte da €99/mese (2 sessioni/settimana), il pacchetto Focus €149/mese (3 sessioni + nutrizione). Offriamo una prova gratuita di 90 minuti senza impegno. Contattaci per un preventivo personalizzato.",
    },
    {
      question: "MUV Fitness è aperto anche il sabato?",
      answer:
        "Sì, siamo aperti dal lunedì al sabato. Orari: Lun-Ven 8:00-21:00, Sabato 8:00-12:00. Domenica chiuso. Prenota il tuo slot online o tramite WhatsApp al 329 107 0374.",
    },
  ],
...
export const getLocalBusinessSchemaData = () => ({
  ...
  image: [BUSINESS_DATA.branding.logo, BUSINESS_DATA.branding.logoAlt],
  logo: {
    "@type": "ImageObject",
  ...
  sameAs: [BUSINESS_DATA.social.facebook, BUSINESS_DATA.social.instagram].filter(Boolean),
  hasOfferCatalog: {
    "@type": "OfferCatalog",
...
export const getServiceSchemaData = (serviceId: string) => {
  ...
  return {
    ...
    areaServed: BUSINESS_DATA.areasServed
