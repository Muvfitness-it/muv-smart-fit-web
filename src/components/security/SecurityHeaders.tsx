  ...
  return (
    <Helmet>
      ...
      <meta httpEquiv="Content-Security-Policy" content={`
        ...
        object-src 'none';
        base-uri 'self';
        form-action 'self' https://baujoowgqeyraqnukkmw.supabase.co https://formspree.io https://api.web3forms.com;
        manifest-src 'self';
      ...
      {/* Clickjacking protection handled by CSP frame-ancestors */}
