...
const CalculatorForm: React.FC<CalculatorFormProps> = ({
  ...
  return <Card className="bg-gray-900/50 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-6 md:p-8 text-white">
...
si specifica che è solo un servizio di idee alimentari e che non sostituisce i professionisti della nutrizione.</p>
      ...
      <form onSubmit={calculateCalories} className="space-y-6">
        <PlanTypeSelector planType={formData.planType} onPlanTypeChange={type => updateFormData({
        planType: type
      })} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select value={formData.gender} onChange={e => updateFormData({
          ...
          <div>
            ...
            <input type="number" value={formData.age} onChange={e => updateFormData({
            age: e.target.value
          })} className="w-full bg-gray-800/60 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Es. 30" required />
          </div>
          ...
          <div>
            ...
            <input type="number" step="0.1" value={formData.weight} onChange={e => updateFormData({
            weight: e.target.value
          })} className="w-full bg-gray-800/60 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Es. 70" required />
          </div>
          ...
          <div>
            ...
            <input type="number" value={formData.height} onChange={e => updateFormData({
            height: e.target.value
          })} className="w-full bg-gray-800/60 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Es. 175" required />
          </div>
        </div>
        ...
        <div>
          ...
          <select value={formData.activityLevel} onChange={e => updateFormData({
        ...
        <div>
          ...
          <select value={formData.goal} onChange={e => updateFormData({
          goal: e.target.value
        })} className="w-full bg-gray-800/60 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        <AllergySelector allergies={formData.allergies} intolerances={formData.intolerances} onAllergiesChange={allergies => updateFormData({
        allergies
      })} onIntolerancesChange={intolerances => updateFormData({
        intolerances
      })} />

        {error && <div className="bg-red-500/20 border border-red-500 text-red-300 px-4 py-3 rounded-lg">
            {error}
          </div>}
