  ...
  const pillars = [
    {
      ...
      description: "EMS Training: 45 minuti equivalgono a 90 minuti di palestra tradizionale. Risultati 4x più veloci.",
      highlight: "45 min = 90 min",
    },
    {
      icon: UserCheck,
      title: "Personalizzazione Totale",
      description:
        "Zero schede standard. Ogni protocollo è costruito su di te, con valutazioni mensili e ottimizzazione costante.",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-foreground">Il Metodo MUV</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {pillars.map((pillar, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-semibold mb-3 text-foreground">{pillar.title}</h3>
                <p className="text-muted-foreground mb-4 text-sm md:text-base">{pillar.description}</p>
