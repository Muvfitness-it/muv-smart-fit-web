  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-6 font-heading text-white drop-shadow-lg">
          Il tuo Personal Trainer a Legnago, senza palestre affollate.
        </h1>
        
        <div className="mb-8 space-y-4">
          <p className="text-xl md:text-2xl lg:text-3xl font-bold text-white drop-shadow-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          ...
          <Link 
            to="/contatti" 
            className="bg-gradient-to-r from-brand-primary via-brand-secondary to-brand-accent hover:opacity-90 text-white px-8 py-4 rounded-full text-lg md:text-xl font-black transition-all duration-300 transform hover:scale-105 shadow-2xl border-2 border-white/20 min-h-[44px] focus:outline-none focus:ring-4 focus:ring-brand-primary/50"
