// BACKUP NAVIGATION - 2025-01-25
// Original Navigation.tsx before cleanstack mobile layout fix
...
const Navigation = () => {
  ...
  return <nav className={`site-header fixed w-full z-50 transition-all duration-300 min-h-[var(--header-height)] flex items-center ${isScrolled || location.pathname !== '/' ? 'bg-gray-900/98 backdrop-blur-md shadow-xl' : 'bg-gray-900/70'}`}>
